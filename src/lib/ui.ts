...
const S = {
  ...
  histLesson: { mm: "သင်ခန်းစာ ပြီးပြီ", en: "Finished lesson" },
  histLevel: { mm: "အဆင့် ပြီးပြီ", en: "Cleared level" },
  timeToday: { mm: "ဒီနေ့", en: "today" },
  timeYesterday: { mm: "မနေ့က", en: "yesterday" },
  timeDaysAgo: { mm: "ရက် အရင်က", en: "days ago" },
  namedOutOf: { mm: "ကြိမ် မှန်ခဲ့", en: "named right" },
  ...
  lensYouPasted: { mm: "သင် ထည့်ထားတဲ့ စာ", en: "What you pasted" },
  lensPointsAt: { mm: "သင့်အဖြေတွေက ညွှန်နေတာ", en: "What your answers point to" },
  lensNothingFlagged: { mm: "သိသာတဲ့ လှည့်ကွက် လက္ခဏာ မတွေ့ရဘူး။ ဒါက အမှန်လို့ မဆိုလိုပါဘူး — စစ်ဖို့တော့ လိုသေးတယ်။", en: "No obvious technique showed up. That does not mean it is true — it still needs checking." },
  lensYouCanCheck: { mm: "သင် စစ်လို့ရတာတွေ", en: "What you can go and check" },
  lensWhatDoYouThink: { mm: "အခု သင် ဘယ်လို ထင်လဲ။", en: "So what do you think?" },
  lensRedo: { mm: "ပြန်စစ်ပါ", en: "Check again" },
  nextForYou: { mm: "သင့်အတွက် နောက်တစ်ခု", en: "Next for you" },
  startLesson: { mm: "စဖတ်ပါ →", en: "Start →" },
  pauseAuto: { mm: "ရပ်ပါ", en: "Pause" },
  playAuto: { mm: "ဆက်ပါ", en: "Play" },
