...
const S = {
  ...
  tableHowBody: {
    mm: "လူတိုင်း တစ်ယောက်ချင်း ဖုန်းကို လျှို့ဝှက်စွာ ကြည့်ပြီး စာတစ်ကြောင်း တည်ဆောက်ပါတယ်။ တစ်ယောက်ကတော့ အခြားသူတွေနဲ့ ဆန့်ကျင်ဘက် အဖြေကို ယုံအောင် လုပ်ရမှာပါ။ ပြီးရင် အားလုံး အသံထွက် ဆွေးနွေးပြီး ဘယ်သူလဲ ခန့်မှန်းကြပါတယ်။",
    en: "Each player looks at the phone privately and builds one line. One of them is secretly arguing the opposite conclusion. Then everyone talks it out and guesses who.",
  },
  ...
  yourSecret: { mm: "သင့် လျှို့ဝှက် တာဝန်", en: "Your secret task" },
  theSituation: { mm: "အခြေအနေ", en: "The situation" },
  buildYourLine: { mm: "အပိုင်းအစ ၂ ခု ရွေးပြီး သင့်စာကြောင်းကို တည်ဆောက်ပါ", en: "Pick 2 fragments to build your line" },
  doneHide: { mm: "ပြီးပြီ — ဖုံးပါ", en: "Done — hide it" },
  lineUpTitle: { mm: "စာကြောင်းအားလုံး", en: "Every line" },
  lineUpBody: { mm: "ဖုန်းကို စားပွဲပေါ် တင်ပါ။ အသံထွက် ဆွေးနွေးပါ။ ဆန့်ကျင်ဘက်ကို တွန်းနေတာ ဘယ်သူလဲ။", en: "Put the phone on the table. Talk it out. Who was pushing the opposite?" },
  ...
  yourVote: { mm: "သင့် မဲ", en: "Your vote" },
  ...
  votedFor: { mm: "မဲပေးခဲ့သူ", en: "voted for" },
  ...
  argueFor: { mm: "သင် ယုံအောင် လုပ်ရမှာ", en: "You must convince the room" },
