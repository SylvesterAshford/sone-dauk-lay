...
export type Lesson = {
  id: string;
  track: number;
  // NOTE: a lesson has no stored "state". Mastery is derived at render time from
  // the player's real progress for `technique` (lib/progress.ts). A hardcoded
  // state field used to live here and shipped fake MASTERED/PRACTISED badges to
  // every user; do not reintroduce it.
...
const CORE_LESSONS: Lesson[] = [
  { id: "t1-urgency", track: 1, technique: "urgency", title: { mm: "အရေးပေါ် ဖိအား", en: "Fake urgency" },
    ...
    how: { mm: "အရေးပေါ်ဖိအားက သင့်ကို တွေးချိန်မပေးဘဲ လုပ်ဆောင်ခိုင်းတယ်။ အချိန်ကန့်သတ်ချက်၊ “ချက်ချင်း”၊ ခြိမ်းခြောက်မှုတို့က ကြောက်စိတ်ကို နှိုးဆွပြီး ဆင်ခြင်တုံတရားကို ပိတ်ပစ်တယ်။", en: "Urgency makes you act before you think — a countdown switches off judgement." },
  ...
  { id: "t1-authority", track: 1, technique: "authority", title: { mm: "အတုအယောင် အာဏာ", en: "False authority" },
    ...
    how: { mm: "ရာထူး၊ တံဆိပ်၊ တရားဝင်ဟန်တို့က ယုံကြည်မှုကို အလိုအလျောက် ရစေတယ်။ ဒါပေမဲ့ ၎င်းတို့ကို အလွယ်တကူ တုပလို့ရတယ်။", en: "Titles and logos manufacture trust — and they are easy to fake." },
  ...
  { id: "t1-emotion", track: 1, technique: "emotion", title: { mm: "စိတ်လှုပ်ရှား ဆွဲဆောင်မှု", en: "Emotional bait" },
    ...
    how: { mm: "ဝမ်းသာမှု၊ ဒေါသ၊ ကြောက်ရွံ့မှု ပြင်းထန်စွာ ဖြစ်လာချိန်တွင် ဆင်ခြင်မှု ကျဆင်းတယ်။ ခံစားချက်ကို လှုံ့ဆော်ခြင်းက လှည့်ကွက်တစ်ခုဖြစ်တယ်။", en: "Strong feeling lowers your guard — that spike is the point." },
  ...
  { id: "t1-doctored", track: 1, technique: "doctored", title: { mm: "ပြင်ဆင်ထားတဲ့ ပုံ/သံ", en: "Doctored media" },
  ...
  { id: "t1-expert", track: 1, technique: "expert", title: { mm: "အတု ကျွမ်းကျင်သူ", en: "Fake expert" },
    meet: { sender: "Dr. Health", meta: "Page · 1d", mm: "ဆရာဝန်တစ်ဦး အနေနဲ့ ဒီဆေးကို အာမခံပါတယ်။", en: '"As a doctor, I guarantee this cure."' },
    how: { mm: "ကျွမ်းကျင်သူဟန် ဆောင်ခြင်းက ယုံစေတယ်။ တကယ့် ကျွမ်းကျင်သူဆို စစ်ဆေးလို့ရတဲ့ အထောက်အထား ချန်ထားတယ်။", en: "Posing as an expert buys belief; a real one leaves checkable evidence." },
  ...
  { id: "t1-context", track: 1, technique: "context", title: { mm: "အကြောင်းအရာ လွဲ", en: "Out of context" },
    ...
    how: { mm: "ပုံ မှန်ပေမဲ့ ဇာတ်လမ်း လွဲနေတတ်တယ်။ ဟောင်းတဲ့ ပုံ/ဗီဒီယိုကို အသစ်လို့ ပြန်တင်လေ့ရှိတယ်။", en: "The image can be real but the story wrong — old media is re-posted as new." },
  ...
  { id: "t2-voice", track: 2, technique: "urgency", title: { mm: "အသံ ပုံတူ (Voice clone)", en: "Voice clones" },
    ...
    how: { mm: "AI က အသံနမူနာ စက္ကန့်အနည်းငယ်နှင့် မည်သူ့အသံကိုမဆို ပုံတူ ဖန်တီးနိုင်ပြီ။ ကြားရုံနဲ့ ယုံလို့ မရတော့ပါ။", en: "AI can clone a voice from seconds of audio. Hearing is no longer believing." },
  ...
  { id: "t2-deepfake", track: 2, technique: "doctored", title: { mm: "Deepfake ဗီဒီယို", en: "Deepfakes" },
    ...
    how: { mm: "မျက်နှာ/နှုတ်ခမ်း လှုပ်ရှားမှုကို AI က ပြောင်းလဲနိုင်ပြီ။ ဟောင်းတဲ့ လက္ခဏာ (မျက်တောင် မခတ်ခြင်း) အချို့ ပျောက်သွားပြီ။", en: "AI can alter faces and lips; some old tells (no blinking) have stopped working." },
  ...
  { id: "t2-aitext", track: 2, technique: "expert", title: { mm: "AI ရေးသား စာသား", en: "AI-written text" },
    ...
    how: { mm: "AI က ချောမွေ့တဲ့ မြန်မာစာကို အလွယ်တကူ ရေးနိုင်ပြီ။ ချောမွေ့မှုက မှန်ကန်မှုကို မဆိုလိုပါ။", en: "AI writes fluent Burmese easily. Fluency is not credibility." },
  ...
  { id: "t3-source", track: 3, technique: "context", title: { mm: "သတင်း ဘယ်ကလာသလဲ", en: "Where information comes from" },
    ...
    how: { mm: "သတင်းတိုင်းမှာ ဖန်တီးသူ၊ ရန်ပုံငွေ၊ ရည်ရွယ်ချက် ရှိတယ်။ “ဘယ်သူ ပြောတာလဲ၊ ဘာကြောင့်လဲ” မေးခြင်းက ပထမ အဆင့်။", en: "Every message has a creator, funding and motive — ask who and why first." },
  ...
  { id: "t3-rumour", track: 3, technique: "emotion", title: { mm: "ကောလာဟလ ဘာကြောင့် မြန်သလဲ", en: "Why rumours travel faster" },
    ...
    how: { mm: "အံ့အားသင့်စေ၊ ဒေါသဖြစ်စေတဲ့ အကြောင်းအရာက ပြင်ဆင်ချက်ထက် ပိုမြန်စွာ ပျံ့နှံ့တယ်။ မှန်ကန်မှုက နှေးတယ်၊ ခံစားချက်က မြန်တယ်။", en: "Content that shocks or angers spreads faster than the correction ever will." },
  ...
  { id: "t3-skept", track: 3, technique: "context", title: { mm: "သံသယ vs အယုံအကြည်ကင်းမှု", en: "Skepticism vs cynicism" },
    ...
    how: { mm: "သံသယက ကာကွယ်ရေး၊ အယုံအကြည် လုံးဝ ကင်းမှုက ချို့ယွင်းချက်။ အားလုံး မှားတယ်လို့ ယူဆရင် မှန်တဲ့ သတင်းကိုပါ လက်လွှတ်ရတယ်။", en: "Skepticism protects you; believing nothing leaves you defenceless too." },
